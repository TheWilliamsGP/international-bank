...
//     type: String, 
//     required: true, 
//     match: [/^\d{8,17}$/, 'Account number must be 8-17 digits'] 
//   },
...
// // Auto populate userId for queries
// transactionSchema.pre(/^find/, function(next) {
//   this.populate('userId', 'name email');
//   next();
// });

// // Utility to mask values
// function maskAllButLast(value = '', visible = 4, maskChar = '*') {
//   const s = String(value || '');
//   if (s.length <= visible) return s;
//   return maskChar.repeat(s.length - visible) + s.slice(-visible);
// }
...
//     transaction.accountNumber = maskAllButLast(transaction.accountNumber, 4);
//   }

//   // Mask card number
//   if (transaction.cardNumber) {
//     transaction.cardNumber = maskAllButLast(transaction.cardNumber, 4);
//   }

//   // Mask CVV completely
//   if (transaction.cardCvv) {
//     transaction.cardCvv = '*'.repeat(transaction.cardCvv.length);
//   }
